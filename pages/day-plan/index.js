...
export default function Index() {
    ...
    return (
        <div className={styles.main_container}>
            ...
            <div className='sidebar px-[20px] flex items-center'>
                <div
                    className={`mr-[15px] ${styles.sidebar}`}
                >
                                ...
                                <div
...

                                    {
                                        isTextVisible && updatedIndex == index ? (
                                            <>
                                                <p
                                                    style={{ fontSize: 12, color: '#7A7676' }}
                                                >{items.disc}</p>
                                                <div className='flex items-center'>
                                                    <Image
                                            ...
                                            <>
                                                <p
                                                    style={{ fontSize: 12, color: '#7A7676' }}
                                                >{items.disc.length > 15 ? items.disc.slice(0, 90) + '...' : items.disc}</p>
                                            </>
                                        )}
                                </div>
                            )
